...
Retreiving the habitat information from SealifeBase, here focusing on the depth range of the crab species, and crossing that information from the BPOW layer:

- 0-800m: coastal and upper bathyal
- 800-3,500m: bathyal
- 3,500-6,500m: abyssal
- 6,500+m: hadal trenches
...
if(traits$depth_range_deep[i]<3500){group_spp[3] <- NA} 
